    ...
    <header class="header-section">
            ...
            <div class="row bg-secondary py-2">
                ...
                <div class="col text-center mt-2">
                    <form action="/logout" method="post">
                        @csrf
                        <button type="submit" class="btn btn-info">{{__('Log Out')}}</button>
                    </form>
                </div>
            </div>
        ...
        @else
            <div class="row py-4 bg-secondary">
                ...
                <div class="col text-center mt-2">
                    <a href="/signup"><button type="button" class="btn btn-info"> {{ __('Sign Up') }} </button></a>
                    <a href="/login"><button type="button" class="btn btn-info"> {{ __('Log In') }} </button></a>
                </div>
            </div>
        @endauth
    </header>
