    ...
    <div class="content container py-5 my-5">
        <form action="/request-login" method="POST">
            ...
            <div class="mb-3 px-5">
                ...
                <input type="email" name="email" id="email" placeholder="{{ __('example@gmail.com') }}" class="form-control @error('email') is-invalid @enderror" autofocus required>
                @error('email')
            ...
            <div class="mb-3 px-5">
                <a href="/signup"> {{ __('sign up here if you didnt have an account') }} </a>
            </div>
        </form>
    </div>
@endsection