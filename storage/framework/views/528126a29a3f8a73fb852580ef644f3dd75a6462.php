<?php $__env->startSection('container'); ?>
    <div class="content container mt-5 mb-5">
        <form action="/request-register" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <h3 class="mb-4"> <?php echo e(__('Sign Up')); ?> </h3>
            <div class="row mb-3">
                <div class="col">
                    <div class="mb-5">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('type your first name here')); ?>" autofocus value="<?php echo e(old('first_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('type your last name here')); ?>" value="<?php echo e(old('last_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" class="form-control" name="password" id="password" placeholder="<?php echo e(__('type your password here')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('type your middle name here')); ?>" value="<?php echo e(old('middle_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('example@gmail.com')); ?>" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <label for="role_id" class="form-label"> <?php echo e(__('Role')); ?> </label>
                        <select name="role_id" id="role_id" class="form-control form-select <?php $__errorArgs = ['role_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <option selected> <?php echo e(__('')); ?> </option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-submit btn-info"> <?php echo e(__('Sign Up')); ?> </button>
            </div>
            <div class="text-center mt-5">
                <a href="/login"> <?php echo e(__('click here to log in if you already have an account')); ?> </a>
            </div>
        </form>
    </div>
    
<?php $__env->stopSection(); ?>
<?php echo $__env->make('masterlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UAS -UTS\webprog\Amazing E-Book 2301926996\resources\views/registerpage.blade.php ENDPATH**/ ?>