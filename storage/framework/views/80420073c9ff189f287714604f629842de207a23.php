...
<body>
    ...
    <header class="header-section">
            ...
            <div class="row bg-secondary py-2">
                ...
                <div class="col text-center mt-2">
                    <form action="/logout" method="post">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="btn btn-info"><?php echo e(__('Log Out')); ?></button>
                    </form>
                </div>
            </div>
            <div class="d-flex justify-content-center bg-dark navbar-home align-items-center py-1">
        ...
        <?php else: ?>
            <div class="row py-4 bg-secondary">
                ...
                <div class="col text-center mt-2">
                    <a href="/signup"><button type="button" class="btn btn-info"> <?php echo e(__('Sign Up')); ?> </button></a>
                    <a href="/login"><button type="button" class="btn btn-info"> <?php echo e(__('Log In')); ?> </button></a>
                </div>
            </div>
        <?php endif; ?>
    </header>
    ...
    <footer>
        <h6 class="footer-section text-lg-center bg-secondary">
            © Amazing E-Book 2022
        </h6>
    </footer>
</body>
</html><?php /**PATH D:\UAS -UTS\webprog\uas\UAS_WP_2301935501\AmazingE-Book\resources\views/masterlayout.blade.php ENDPATH**/ ?>