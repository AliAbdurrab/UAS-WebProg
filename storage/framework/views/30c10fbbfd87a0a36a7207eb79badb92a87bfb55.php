<?php $__env->startSection('container'); ?>
    ...
    <div class="container content my-5 px-5">
        ...
        <form class="text-center" action="/request-rent" method="POST">
            ...
            <button type="submit" class="btn btn-warning px-5" > <?php echo e(__('Rent')); ?></button>
        </form>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('masterlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UAS -UTS\webprog\Amazing E-Book 2301926996\resources\views/bookdetailpage.blade.php ENDPATH**/ ?>